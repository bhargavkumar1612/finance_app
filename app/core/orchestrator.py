...
_NEXT_ACTIONS = {
    Intent.add_expense: ["Add another expense", "View this month's spending", "What's my net worth?"],
    Intent.net_worth_query: ["Add an expense", "Spending breakdown", "Import statement"],
    Intent.spending_analysis: ["What's my net worth?", "Add an expense", "Import statement"],
    ...
    Intent.track_subscriptions: ["Add an expense", "Spending breakdown"],
