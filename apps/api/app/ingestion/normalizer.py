...
def normalize_row(raw: dict[str, Any], account_type: str | None = None) -> NormalizedTransaction:
    """
    ...
    csv_category = _trim_merchant(raw.get("category"), max_len=100)
    suggested_category = csv_category or auto_categorize(merchant or "", raw_desc or "")
    ...
    return NormalizedTransaction(
        ...
        suggested_nw_impact=impact.value,
    )
